function [subpix_x, subpix_y, subpix_dir_x, subpix_dir_y, subpix_grad_x, subpix_grad_y, subpix_id_map] = NMS_token(Gx, Gy, G, mask, margin)
...
subpix_id_map = zeros(size_y, size_x);
